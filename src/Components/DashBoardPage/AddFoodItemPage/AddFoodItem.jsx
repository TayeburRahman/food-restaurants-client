        ...
        <div className="col-md-8 offset-md-2">
          <div className="px-3">
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <label className="d-flex justify-content-start mt-3">
                *Category :
              </label>
              <input
                className="form-control border-0 border-bottom mb-2"
              ...
              <label className="d-flex justify-content-start mt-3" htmlFor="">
                *Food Ingredient :
              </label>
                ...
                {Instructions.map((item, index) => {
                  return (
                    <li key={Math.random()} className="d-flex">
                      <textarea
                        className="form-control mb-2 me-1"
                        {...register(`foodInstructions.${index}.instructions`)}
                      />
                      <button
                        type="button"
                        className="btn btn-sm mb-2 btn-dark"
              ...
              <div className="row">
                ...
                <div className="col-sm-6">
                  ...
                  />
                  {errors.tags && (
                    <span className="text-danger">* Tag field is required</span>
                  )}
                </div>
              </div>
              ...
              <input
                onChange={(e) => handleImgUpload(e, setImageUrl1)}
                className="form-control border-0 border-bottom mb-2"
                type="file"
                name="One"
                required
              ...
              <input
                onChange={(e) => handleImgUpload(e, setImageUrl2)}
                className="form-control border-0 border-bottom mb-2"
                type="file"
                name="Two"
                required
              ...
              <input
                onChange={(e) => handleImgUpload(e, setImageUrl3)}
                className="form-control border-0 border-bottom mb-2"
                type="file"
                name="Three"
                required
