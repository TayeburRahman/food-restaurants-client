...
const NewBlogPost = () => {
  ...
  const onSubmit = (data) => {
    ...
    fetch("https://restaurants-server.vercel.app/addBlog", {
      method: "POST",
        ...
        <div className="col-md-8 offset-md-2">
          <div className="px-3">
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                {Ingredients.map((item, index) => {
                  return (
                    <li key={Math.random()} className="d-flex">
                      <textarea
                        className="form-control mb-2 border-0 border-bottom me-1"
                ...
                {Directions.map((item, index) => {
                  return (
                    <li key={Math.random()} className="d-flex">
                      <textarea
                        className="form-control mb-2 border-0 border-bottom me-1"
                        {...register(`Directions.${index}.directions`)}
                      />
                      <button
                        type="button"
                        className="btn btn-sm mb-2 btn-dark"
              ...
              <input
                onChange={(e) => handleImgUpload(e, setBlogImage)}
                className="form-control mb-2 border-0 border-bottom"
                type="file"
                name="One"
                required
              ...
              <input
                onChange={(e) => handleImgUpload(e, setChefImage)}
