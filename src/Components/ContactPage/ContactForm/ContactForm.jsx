  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className="d-flex align-items-center">
        ...
        <input
          className="form-control ms-2 border-0 border-bottom"
          type="text"
          placeholder="Name"
      ...
      <div className="d-flex align-items-center mt-2">
        ...
        />
        {errors.Phone && (
          <span className="text-danger">* Phone field is required</span>
        )}
      </div>
      <br />
      ...
      <div className="d-flex align-items-center mt-2">
        ...
        />
        {errors.Message && (
          <span className="text-danger">* Message field is required</span>
        )}
      </div>
