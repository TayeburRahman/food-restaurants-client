  ...
  return (
    <footer className={styles.footerWrapper}>
      <div className="container">
        ...
        <div className={styles.aboutWrapper}>
          <div className={styles.aboutData}>
            ...
            <p>
              {" "}
              <strong>Dingo</strong> is located on the “Roof top” level of the
              City Place Convention Centre adjacent to the Pan Pacific Hotel. We
              have a bright, contemporary space where diners are surrounded by
              floor to ceiling windows. Enjoy the breathtaking views of City
              Park, Coal Harbour Shore, the National Gate Bridge and our World
              Class Ski Hills.{" "}
            </p>
          </div>
        </div>
      ...
      <div className="text-center">
        <p className="px-3">
          Copyright © {date.getFullYear()} Bingo Restaurant. All rights reserved
          by <i style={{ fontSize: 20 }}>&hearts;</i> Dingo.
        </p>
      </div>
    </footer>
  );
