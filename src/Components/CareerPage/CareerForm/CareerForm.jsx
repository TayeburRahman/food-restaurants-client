    ...
    <div className="container pt-5">
      <div className="row">
        <div className="col-md-6 mb-3">
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="d-flex align-items-center">
              ...
              <input
                className="form-control ms-2 border-0 border-bottom mb-2"
                type="text"
            ...
            <div className="d-flex align-items-center mt-3">
              ...
              <textarea
                className="form-control ms-2 border-0 border-bottom mb-2"
                type="text"
                placeholder="Introduces Yourself"
                {...register("about", { required: true })}
              />
              {errors.about && (
                <span className="text-danger">
                  * Introduces field is required
                </span>
              )}
            </div>
        ...
        <div className="col-md-6">
          ...
          <p>
            Dear applicant you please let us to know if you are good enough
            suitable for join our restaurant please notify us if we have any
            vacancy.
          </p>
        </div>
      </div>
