import { faCar, faWallet, faWifi } from "@fortawesome/free-solid-svg-icons";
    ...
    <section className={styles.BookTableWrapper}>
      <div className="container">
              ...
              <div className="p-3">
                <div className="row">
                  <div className={`col-md-6 mb-2 ${styles.InputGroup}`}>
                    <label htmlFor="ReservationDate" className="ms-2 mb-1">
                      *Reservation Date :
                    </label>
                    <input
                      type="date"
                  ...
                  <div className={`col-md-6 mb-2 ${styles.InputGroup}`}>
                    <label htmlFor="ReservationTime" className="ms-2 mb-1">
                      *Reservation Time :
                    </label>
                    <select
                ...
                <div className="row">
                  <div
                    className={`col-md-6 mb-2 col-lg-4 ${styles.InputGroup}`}
                  >
                    <label htmlFor="people" className="ms-2 mb-1">
                      *People :
                    </label>
                    <input
                      type="number"
                  ...
                  <div
                    className={`col-md-6 mb-2 col-lg-4 ${styles.InputGroup}`}
                  >
                    <label htmlFor="table" className="ms-2 mb-1">
                      *Table No :
                    </label>
                    <select
                      className="form-select border-0 border-bottom"
                  ...
                  <div
                    className={`col-md-6 mb-2 col-lg-4 mx-auto ${styles.InputGroup}`}
                  >
                    <label htmlFor="phone" className="ms-2 mb-1">
                      *Phone Number :
                    </label>
                    <input
                      type="tel"
        ...
        <h3 className="mt-5 text-center">
          You can also call: +880 172 222 5555 to make a reservation.
        </h3>
      </div>
    </section>
  );
