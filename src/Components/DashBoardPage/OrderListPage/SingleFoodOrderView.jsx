                ...
                <div className="row">
                  ...
                  <div className="col-md-6">
                    ...
                    <p className="card-text m-0 mb-2">
                      Card Expire Date : {order.expireDate}
                    </p>
                  </div>
                </div>
                <div className="row">
                  <div className="d-flex">
                    ...
                    <p style={{ marginTop: 2 }}>
                      {order.Bill} Tk <strong>Paid</strong>
                    </p>
                  </div>
                </div>

                {cartItems.map((singleCart) => (
                  <div key={Math.random()}>
                    <div className="card my-3">
                      <div className="row g-0">
                        <div className="col-md-4 my-auto">
                          <img
                            src={singleCart.makingPic1}
                        ...
                        <div className="col-md-8">
                          <div className="card-body">
                            ...
                            <p className="card-text mb-0">
                              Food Type : {singleCart.type}
                            </p>
                            <p className="card-text mb-0">
                              Description : {singleCart.shortDescription}
                            </p>
                          </div>
                        </div>
                      </div>
