...
const UpdateMenu = () => {
  ...
  const onSubmit = (data) => {
    ...
    let FoodInstructions = updateInstruction.concat(
      data.foodInstructions.map((ele) => ele.instructions)
    );
    // console.log(updateIngredient)
    let Ingredient = updateIngredient.concat(
      data.ingredient.map((ele) => ele.ingredient)
    );
    const upData = {
      ...data,
                ...
                <div className="card border-0 shadow m-3">
                  <div className="card-body">
                    <button
                      ...
                      type="button"
                      className="btn btn-sm mb-3 btn-success"
                    >
                      Back
                    </button>
                    {user && (
                      <form onSubmit={handleSubmit(onSubmit)}>
                        <div className="form-row">
                          <label className="d-flex justify-content-start ms-2">
                            *Title :
                          </label>
                          <input
                            defaultValue={title}
                          ...
                          <label className="d-flex justify-content-start mt-3 ms-2">
                            *Category :
                          </label>
                          <input
                          ...
                          {updateIngredient.map((singleIngredient, index) => (
                            <div key={Math.random()}>
                              <li
                                key={index}
                                className="d-flex justify-content-start mb-2 ms-2"
                              >
                                Ingredient {index + 1}
                              </li>
                              <textarea
                                type="text"
                                onBlur={(e) =>
                                  handleIngredient(e.target.value, index)
                                }
                                defaultValue={singleIngredient}
                                className="form-control border-0 border-bottom mb-2"
                              />
                            </div>
                          ))}
                            ...
                            {Ingredient.map((item, index) => {
                              return (
                                <li key={Math.random()} className="d-flex">
                                  ...
                                  <button
                                    type="button"
                                    className="btn btn-sm mb-2 btn-dark"
                            ...
                            {updateInstruction.map(
                              (singleInstruction, index) => (
                                <div key={Math.random()}>
                                  ...
                                  <textarea
                                    onBlur={(e) =>
                                      handleInstruction(e.target.value, index)
                                    }
                                    defaultValue={singleInstruction}
                                    className="form-control border-0 border-bottom mb-2"
                                    type="text"
                                  />
                                </div>
                              ...
                              return (
                                <li key={Math.random()} className="d-flex">
                                  <textarea
                                    className="form-control mb-2 me-1"
                                    {...register(
                                      `foodInstructions.${index}.instructions`
                                    )}
                                  />
                                  <button
                                    type="button"
                          ...
                          <div className="row">
                            <div className="col-sm-6">
                              ...
                              >
                                <option value="HomeMenu">
                                  Add To Home Menu
                                </option>
                                <option value="BreakFastFood">
                                  Add To Breakfast Food
                                </option>
                                <option value="BreakFastDrink">
                                  Add To Breakfast Drink
                                </option>
                                <option value="LunchFood">
                                  Add To Lunch Food
                                </option>
                                <option value="LunchDrink">
                                  Add To Lunch Drink
                                </option>
                                <option value="DinnerFood">
                                  Add To Dinner Food
                                </option>
                                <option value="DinnerDrink">
                                  Add To Dinner Drink
                                </option>
                              </select>
                              {errors.type && (
                          ...
                          <div className="row">
                            <div className="col-sm-6">
                              ...
                              <input
                                defaultValue={readyTime}
                                className="form-control border-0 border-bottom mb-2"
                                type="text"
                                placeholder="Ready Time : etc 30 Minutes"
                                {...register("readyTime", { required: true })}
                              />
                              {errors.readyTime && (
                                <span className="text-danger">
                                  * Ready Time field is required
                                </span>
                              )}
                            </div>
                            <div className="col-sm-6">
                              ...
                              <input
                                ...
                                className="form-control border-0 border-bottom mb-2"
                                type="text"
                                placeholder="Prep Time : etc 30 Minutes"
                                {...register("prepTime", { required: true })}
                              />
                              {errors.prepTime && (
                                <span className="text-danger">
                                  * Prep Time field is required
                                </span>
                              )}
                            </div>
                          </div>
                          ...
                          <div className="row">
                            <div className="col-sm-6">
                              ...
                              <input
                                ...
                                className="form-control border-0 border-bottom mb-2"
                                type="text"
                                placeholder="Cook Time : etc 30 Minutes"
                                {...register("cookTime", { required: true })}
                              />
                              {errors.cookTime && (
                                <span className="text-danger">
                                  * Cook Time field is required
                                </span>
                              )}
                            </div>
                            <div className="col-sm-6">
